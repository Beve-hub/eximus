...
const Company = () => {
  return (
    <section className="max-w-7xl w-full mx-auto grid md:grid-cols-2 gap-14 items-start mt-12">
      {/* Left column */}
      <div>
        ...
        <p className="text-sm text-gray-500 leading-relaxed max-w-xl">
          ...
          <br/> <br />
          Our
          people understand both the technical demands of oil and gas facilities
          and the commercial discipline required to deliver projects under
