...
var Footer = function () {
    return (React.createElement("footer", { className: "bg-[#0a0f1c] border-t border-amber-500/10 pt-16 pb-12" },
            ...
            React.createElement("div", { className: "grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-12" },
                React.createElement("div", { className: "lg:col-span-5" },
                    React.createElement(link_1["default"], { href: "/", className: "inline-flex items-center gap-4 mb-6" },
                        React.createElement(image_1["default"], { src: Logo_png_1["default"], alt: "Company Logo", className: "h-25 w-auto brightness-110 drop-shadow-xl", priority: true })),
